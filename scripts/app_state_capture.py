...
class AppStateCapture:
    ...
    def __init__(self, app_bundle_id: Optional[str] = None, udid: Optional[str] = None):
        """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Capture complete app state for debugging'
    )
    parser.add_argument(
        '--app-bundle-id',
        help='App bundle ID for log filtering (e.g., com.example.app)'
    )
    parser.add_argument(
        '--output',
        default='.',
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help='Number of log lines to capture (default: 100)'
    )
    parser.add_argument(
        '--udid',
